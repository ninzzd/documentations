...
- Any explanation as to why MAC is less verifiable than DP-MVM? (SCA-DP, ForMAt)
- You have mentioned future work on MVM and MMM?
- SCA and general formal verification for FP or systolic arrays?
- For large designs (FP) : use SCA to verify small modules (Mul, Add, Shift, etc) : contruct graph of modules (more complicated than AIG) : solve using backwards rewriting : Is recursive SCA a thing? What's so special about SCA?
